...
void RewardsServiceImpl::SavePublisherVisitChannel(
    const uint64_t window_id,
    const std::string& media_type,
    const std::string& url,
    const std::string& channel_id,
  ...
  bat_ledger_->SavePublisherVisitChannel(
      window_id,
      media_type,
      url,
      channel_id,
...
void RewardsServiceImpl::SavePublisherVisitUser(
    const uint64_t window_id,
    const std::string& media_type,
    const std::string& url,
    const std::string& channel_id,
  ...
  bat_ledger_->SavePublisherVisitUser(
      window_id,
      media_type,
      url,
      channel_id,
...
void RewardsServiceImpl::SavePublisherVisitVideo(
    const uint64_t window_id,
    const std::string& media_type,
    const std::string& url,
    const std::string& channel_id,
  ...
  bat_ledger_->SavePublisherVisitVideo(
      window_id,
      media_type,
      url,
      channel_id,
...
void RewardsServiceImpl::SavePublisherVisitCustom(
    const uint64_t window_id,
    const std::string& media_type,
    const std::string& url,
    const std::string& channel_id,
  ...
  bat_ledger_->SavePublisherVisitCustom(
      window_id,
      media_type,
      url,
      channel_id,
